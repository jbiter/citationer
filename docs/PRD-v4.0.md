...
> 不绑定具体大版本，以持续维护、文档完善和社区生态建设为主，根据实际反馈穿插发布。
...
> 📝 **下一版迭代建议**:
> 1. P5-4 PDF 全文分析 — Phase 5 当前重点，扩展本地分析能力，支持全文主题建模
> 2. P5-7 多语言国际化 (i18n) — 降低非中文用户使用门槛
> 3. Phase 7 维护与生态项（P5-5 实时文献监控、P5-8 EndNote/Zotero 解析器、P6-1 协作功能）— 根据社区反馈穿插迭代
> 4. 持续收集 GitHub Issues 反馈，按实际优先级滚动调整 v5.x / v6.x 排期
